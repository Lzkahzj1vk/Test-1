        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="font-black text-xl tracking-tight text-white">LUXORA</span>
            </Link>
            <p className="text-sm leading-relaxed mb-6 max-w-xs">
              Crafting premium furniture experiences that transform houses into dream homes. Quality that lasts a lifetime.
            </p>
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm">+1 (800) 555-LUXO</span>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="w-4 h-4 text-neutral-500 flex-shrink-0" />
                <span className="text-sm">hello@luxora.com</span>
              </div>
            </div>
            {/* Social */}
            <div className="flex items-center gap-3 mt-6">
              {[
                ...
                <a
                  ...
                  href={href}
                  aria-label={label}
                  className="w-9 h-9 border border-neutral-800 rounded-full flex items-center justify-center hover:border-white hover:text-white transition-colors"
                >
                  <Icon />
                </a>
              ))}
      ...
      <div className="border-t border-neutral-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="#" className="text-xs hover:text-white transition-colors">Cookie Policy</Link>
          </div>
          <div className="flex items-center gap-2">
            {["visa", "mc", "amex", "paypal"].map((card) => (
              <div key={card} className="px-2 py-1 bg-neutral-900 rounded text-xs text-neutral-400 font-medium uppercase">
                {card}
              </div>
            ))}
          </div>
