...
export default function Button({
  ...
  const base =
    "inline-flex items-center justify-center gap-2 font-medium transition-all duration-200 rounded-full cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed select-none";
  ...
  const variants = {
    ...
    ghost: "text-black hover:bg-neutral-100 active:scale-95",
